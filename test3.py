...
pygame.mixer.music.load('Flappy Bird Theme Song.mp3')  # Use the correct path to your music file
...
# Font
font = pygame.font.Font('pixely[1].ttf', 20)
...
def display_message(text, color, center_x, center_y):
    screen_text = font.render(text, True, color)
    text_rect = screen_text.get_rect(center=(center_x, center_y))
...
def show_start_screen():
    ...
    display_message("Press ANY key to start", BLACK, WIDTH // 2, HEIGHT // 2)
...
def game_loop():
    ...
    while running:
        ...
        if game_over:
            ...
            display_message(f'Game Over! Final Score: {score}', BLACK, WIDTH // 2, HEIGHT // 2 - 40)
            display_message(f'High Score: {high_score}', BLACK, WIDTH // 2, HEIGHT // 2)
            display_message('Press SPACE to Restart', BLACK, WIDTH // 2, HEIGHT // 2 + 40)
        else:
            display_message(f'Score: {score}', BLACK, 60, 20)
            display_message(f'High Score: {high_score}', BLACK, 100, 50)
